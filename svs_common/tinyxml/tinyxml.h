...
/*lint -e578 -e1551 -e1772 -e1529 -e1055 -e746 -e730 -e534 -e1763 -e740 -e433 -e826 -e220 -e673 -e1509 -e1722 -e1540 -e516 */
...
private:
    ...
    void operator=( const TiXmlBase& base );    // not allowed. Lint Info 1722
