...
enum SVS_MSG_TYPE_LIST
{
    ...
    SVS_MSG_TYPE_STREAM_LOAD_INFO_REQ                              = 0x00000009,
    SVS_MSG_TYPE_STREAM_LOAD_INFO_RESP                             = 0x0000000a,
    SVS_MSG_TYPE_STREAM_SESSION_SETUP_REQ                          = 0x0000000b,
    SVS_MSG_TYPE_STREAM_SESSION_SETUP_RESP                         = 0x0000000c,
    SVS_MSG_TYPE_STREAM_SESSION_PLAY_REQ                           = 0x0000000d,
    SVS_MSG_TYPE_STREAM_SESSION_PLAY_RESP                          = 0x0000000e,
    SVS_MSG_TYPE_STREAM_SESSION_TEARDOWN_REQ                       = 0x0000000f,
    SVS_MSG_TYPE_STREAM_SESSION_TEARDOWN_RESP                      = 0x00000010,
