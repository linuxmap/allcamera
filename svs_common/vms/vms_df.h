...
enum ROUTE_STOP_REASON
{
    ...
    ROUTE_STOP_REASON_STREAM_MIN            = 0x00010000,
    ROUTE_STOP_REASON_STREAM_CLIENT_DISCON  = 0x00020000,//客户端或者MRU断开连接
    ROUTE_STOP_REASON_STREAM_STREAM_ERROR   = 0x00030000,//前端媒体流数据异常
    ROUTE_STOP_REASON_STREAM_DEV_DISCON     = 0x00040000,//前端断开连接
    ROUTE_STOP_REASON_STREAM_SCHEDULE_ERROR = 0x00050000,//调度重新启动
    ROUTE_STOP_REASON_STREAM_RECVTIMEOUT    = 0x00060000,//接收前端数据超时
    ROUTE_STOP_REASON_STREAM_EXCEPTION       = 0X00070000,//mdu自身异常
    ROUTE_STOP_REASON_STREAM_MAX            = 0x00FF0000,
    ...
    ROUTE_STOP_REASON_SCC_STREAM_ERROR      = 0x04000000,//MDU异常
